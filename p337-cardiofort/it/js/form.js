...
let prefix = () => {
    let dropdown = "country" + $("#country :selected").val();
    let valueName = eval(dropdown);
    $("#country_phone").val(valueName.prefix);
...
$.get("https://freegeoip.app/json/", function(response) {
    $(`#country option[value=${response.country_code}]`).attr('selected', 'selected');
    prefix();
}, "jsonp");
