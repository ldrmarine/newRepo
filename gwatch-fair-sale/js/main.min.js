!(function (e, t) {
  ...
  var h = (function (n) {
    ...
    function ae(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : w) !== k && T(t), (t = t || k), S)
      ) {
        if (11 !== p && (l = te.exec(e)))
          if ((o = l[1])) {
            if (9 === p) {
            ...
            if (
              ...
              return P.apply(n, t.getElementsByClassName(o)), n;
          }
        if (
          f.qsa &&
          !D[e + " "] &&
            ...
            ? function (e, t) {
                ...
                return (
                  ...
                  (!f.sortDetached && t.compareDocumentPosition(e) === n)
                    ? e === k || (e.ownerDocument === w && m(w, e))
                      ? -1
                      : t === k || (t.ownerDocument === w && m(w, t))
                      ? 1
                      : l
                      ? M(l, e) - M(l, t)
                      : 0
    ...
    (ae.attr = function (e, t) {
      ...
      var n = b.attrHandle[t.toLowerCase()],
        i = n && O.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !S) : void 0;
      return void 0 !== i
        ? i
        : f.attributes || !S
        ? e.getAttribute(t)
                ...
                if (d) {
                  if (y) {
                    for (; c; ) {
                      for (s = e; (s = s[c]); )
                        if (
                          w ? s.nodeName.toLowerCase() === u : 1 === s.nodeType
                        )
                          return !1;
      ...
      return (
        ...
        ce(function (e, t, n, i) {
          var o,
            ...
            p = v ? (y || (e ? f : c || g) ? [] : t) : u;
          if ((v && v(u, p, n, i), g))
            for (o = Te(p, l), g(o, [], n, i), r = o.length; r--; )
              (s = o[r]) && (p[l[r]] = !(u[l[r]] = s));
          if (e) {
            if (y || f) {
              if (y) {
          ...
          (s = j(
            ...
            (i = function (e, t, n, i, o) {
              ...
              if (((l += c), m && c !== l)) {
                ...
                if (e) {
                  if (0 < l) for (; c--; ) d[c] || u[c] || (u[c] = H.call(i));
                  u = Te(u);
                }
                P.apply(i, u),
                  o &&
        ...
        if (((n = n || []), 1 === d.length)) {
          ...
          for (
            ...
            if (
              (l = b.find[a]) &&
              (i = l(
                s.matches[0].replace(ie, u),
                (ne.test(r[0].type) && ye(t.parentNode)) || t
              ))
            ) {
              if ((r.splice(o, 1), !(e = i.length && we(r))))
  ...
  (C.filter = function (e, t, n) {
    ...
    C.fn.extend({
      ...
      is: function (e) {
        return !!D(this, "string" == typeof e && A.test(e) ? C(e) : e || [], !1)
          .length;
      },
    });
  var L,
      ...
      function (i, o) {
        C.fn[i] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (N[i] || C.uniqueSort(n), H.test(i) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  function xe(e, t, n, i, o) {
    ...
    for (u.textContent = "", f = 0; (r = p[f++]); )
      if (i && -1 < C.inArray(r, i)) o && o.push(r);
        ...
        ((c = re(r)), (s = ge(u.appendChild(r), "script")), c && ye(s), n)
      )
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && E(t, "input") && je(t, "click", Ce),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && E(t, "input") && je(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Ie(n, i, o, r) {
    ...
    var e,
      ...
      f = i[0],
      h = w(f);
    if (h || (1 < u && "string" == typeof f && !m.checkClone && Oe.test(f)))
    ...
    if (
      u &&
      ((t = (e = xe(i, n[0].ownerDocument, !1, n, r)).firstChild),
      1 === e.childNodes.length && (e = t),
      t || r)
    ) {
      for (a = (s = C.map(ge(e, "script"), Pe)).length; d < u; d++)
        (l = e),
          d !== p &&
            ((l = C.clone(l, !0, !0)), a && C.merge(s, ge(l, "script"))),
          o.call(n[d], l, d);
      if (a)
        for (c = s[s.length - 1].ownerDocument, C.map(s, qe), d = 0; d < a; d++)
          (l = s[d]),
            he.test(l.type || "") &&
  ...
  C.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (r = r || ge(e), s = s || ge(d), i = 0, o = r.length; i < o; i++)
            Me(r[i], s[i]);
        else Me(e, d);
      return (
        0 < (s = ge(d, "script")).length && ye(s, !u && ge(e, "script")), d
      );
    },
  ...
  function Ke() {
    if (Xe) {
      (Ue.style.cssText =
        ...
        oe.appendChild(Ue).appendChild(Xe);
  ...
  function ct(e, t, n, i, o, r) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += C.css(e, n + ie[s], !0, o)),
        i
          ? ("content" === n && (l -= C.css(e, "padding" + ie[s], !0, o)),
            "margin" !== n &&
  ...
  function xt(e, t, n) {
    for (
      var i,
        o = (Tt.tweeners[t] || []).concat(Tt.tweeners["*"]),
        r = 0,
        s = o.length;
      r < s;
      r++
  ...
  (C.Animation = C.extend(Tt, {
    ...
    tweener: function (e, t) {
      for (
        var n, i = 0, o = (e = w(e) ? ((t = e), ["*"]) : e.match(q)).length;
        i < o;
        i++
      )
        (n = e[i]),
        ...
        if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              v && ue([e], !0),
              p.done(function () {
                for (i in (v || ue([e]), Q.remove(e, "fxshow"), f))
                  C.style(e, i, f[i]);
              })),
              (l = xt(v ? g[i] : 0, i, p)),
              i in g ||
    ...
    (vt = S.createElement("select").appendChild(S.createElement("option"))),
    (ht.type = "checkbox"),
    (m.checkOn = "" !== ht.value),
    (m.optSelected = vt.selected),
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : Ct.test(e.nodeName) || ($t.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
    ...
    C.fn.extend({
      ...
      hasClass: function (e) {
        var t,
          ...
          i = 0;
        for (t = " " + e + " "; (n = this[i++]); )
          if (1 === n.nodeType && -1 < (" " + At(Et(n)) + " ").indexOf(t))
            return !0;
        return !1;
      },
    });
  ...
  C.extend(C.event, {
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        if (!i && !d.noBubble && !v(n)) {
          for (
            a = d.delegateType || f, Ot.test(a + f) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            p.push(r), (s = r);
        ...
        for (o = 0; (r = p[o++]) && !e.isPropagationStopped(); )
          (u = r),
            ...
            (c = (Q.get(r, "events") || {})[e.type] && Q.get(r, "handle")) &&
              c.apply(r, t),
            (c = l && r[l]) &&
              c.apply &&
              G(r) &&
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = n[l]) && (n[l] = null),
              (C.event.triggered = f),
              e.isPropagationStopped() && u.addEventListener(f, Lt),
              n[f](),
              e.isPropagationStopped() && u.removeEventListener(f, Lt),
  ...
  function zt(n, e, i, o) {
    ...
    else for (t in e) zt(n + "[" + t + "]", e[t], i, o);
  }
  ...
  (Qt.href = Ht.href),
    C.extend({
      ...
      ajax: function (e, t) {
        ...
        g.hasContent
          ...
          : ((r = g.url.slice(u.length)),
            g.data &&
              ...
              ((u += (Pt.test(u) ? "&" : "?") + g.data), delete g.data),
            !1 === g.cache &&
              ((u = u.replace(Bt, "$1")),
              (r = (Pt.test(u) ? "&" : "?") + "_=" + Nt++ + r)),
            (g.url = u + r)),
        ...
        if (g.beforeSend && (!1 === g.beforeSend.call(y, T, g) || h))
          return T.abort();
        if (
          ((l = "abort"),
          b.add(g.complete),
          ...
          if (((T.readyState = 1), v && m.trigger("ajaxSend", [T, g]), h))
            return T;
          g.async &&
            0 < g.timeout &&
        ...
        function c(e, t, n, i) {
          ...
          h ||
            ...
            T.statusCode(x),
            (x = void 0),
            v && m.trigger(o ? "ajaxSuccess" : "ajaxError", [T, g, o ? r : s]),
            b.fireWith(y, [T, c]),
            v &&
  ...
  C.ajaxSetup({
    ...
    C.ajaxPrefilter("json jsonp", function (e, t, n) {
      ...
      if (s || "jsonp" === e.dataTypes[0])
        return (
          (i = e.jsonpCallback = w(e.jsonpCallback)
            ? e.jsonpCallback()
            : e.jsonpCallback),
          s
    ...
    C.each(["top", "left"], function (e, n) {
      C.cssHooks[n] = Je(m.pixelPosition, function (e, t) {
        if (t)
          return (t = Qe(e, n)), Ye.test(t) ? C(e).position()[n] + "px" : t;
      });
    }),
  ...
  return (
    (C.noConflict = function (e) {
      return k.$ === C && (k.$ = an), e && k.jQuery === C && (k.jQuery = sn), C;
    }),
    e || (k.jQuery = k.$ = C),
    C
  );
  ...
  $(document).ready(function () {
    $(".show-form").click(function () {
      ...
      $(".feedback").click(function () {
        $(".popup-window").removeClass("closed");
      }),
      $(".close-popup").click(function () {
        $(".popup-window").addClass("closed");
      }),
      ...
      $(".reviews-wrapper").slick({ arrows: !1, dots: !0, adaptiveHeight: !0 });
  }),
  document.addEventListener("DOMContentLoaded", function () {
    var r = new Array(document.querySelectorAll(".timerWrapper"))[0];
    if (localStorage.getItem("timeLeft"))
      var s = localStorage.getItem("timeLeft");
    else s = 1800;
    setInterval(function () {
      0 == s &&
        (alert("Il tempo è scaduto! Soprattutto per te, lo prolungheremo per 30 minuti!"),
        (s = 1800)),
        s--;
      var e = Math.floor(s / 3600),
        ...
        n = Math.floor(t / 60),
        i = t % 60;
      e < 10 && (e = "0" + e), n < 10 && (n = "0" + n), i < 10 && (i = "0" + i);
      var o = [];
      o.push(e),
        o.push(n),
        o.push(i),
        r.forEach(function (e) {
          !(function (e, t) {
            (e.querySelector(".timer-hour").innerHTML = t[0]),
              (e.querySelector(".timer-minutes").innerHTML = t[1]),
              (e.querySelector(".timer-seconds").innerHTML = t[2]);
          })(e, o);
        }),
        localStorage.setItem("timeLeft", s);
    }, 1e3);
  }),
  function () {
    !(function () {
      ...
      if (!self.fetch) {
        ...
        c.call(d.prototype),
          ...
          (self.fetch = function (e, t) {
            var n;
            return (
              (n = d.prototype.isPrototypeOf(e) && !t ? e : new d(e, t)),
      ...
      function p(e, t) {
        (t = t || {}),
          ...
          (this.headers =
            t.headers instanceof a ? t.headers : new a(t.headers)),
          (this.url = t.url || "");
      }
    })(),
      (function (n, i) {
          ...
          (d = d && d.setTimeout ? d : n),
            (e =
              "[object process]" === {}.toString.call(n.process)
                ? function () {
                    var e = u(arguments);
                    return process.nextTick(p(f, e)), e;
                  }
                : (function () {
                ...
                ? ((r = "setImmediate$" + Math.random() + "$"),
                  n.addEventListener
                    ? n.addEventListener("message", v, !1)
                    : n.attachEvent("onmessage", v),
                  function () {
                    var e = u(arguments);
                    return n.postMessage(r + e, "*"), e;
                  })
                : n.MessageChannel
                ...
                : function () {
                    var e = u(arguments);
                    return setTimeout(p(f, e), 0), e;
                  }),
            (d.setImmediate = e),
            (d.clearImmediate = h);
        }
        function u(e) {
          return (a[s] = p.apply(i, e)), s++;
        }
        function p(e) {
          var t = [].slice.call(arguments, 1);
          return function () {
            "function" == typeof e ? e.apply(i, t) : new Function("" + e)();
          };
        }
        function f(e) {
          if (l) setTimeout(p(f, e), 0);
          else {
            var t = a[e];
            if (t) {
              l = !0;
      ...
      (function (e) {
        ...
        var c = "[[PromiseStatus]]",
          ...
          v = "rejected",
          g = "not an array.",
          t = 'constructor Promise requires "new".',
          y = e.setImmediate || require("timers").setImmediate,
          m =
            Array.isArray ||
            function (e) {
        ...
        function C(e, t) {
          var n = e[p];
          (e[c] = v), (e[d] = t), n && n.length && (s(e), a(n));
        }
        function $(e) {
          if (!x(this)) throw new TypeError(t);
          (this[c] = i), (this[d] = void 0), l(this, e);
        }
        ($.prototype.then = function (r, s) {
          var a,
            l = this;
          return (
            (r = b(r) ? r : n),
          ...
          ($.race = function (o) {
            return new $(function (e, t) {
              var n, i;
              if (m(o)) for (i = o.length, n = 0; n < i; n++) k(e, t, o[n]);
              else t(new TypeError(g));
            });
          }),
          ($.all = function (l) {
            return new $(function (n, e) {
              var t,
                ...
                a = 0;
              if (m(l)) {
                for (i = (l = l.slice(0)).length, r = 0; r < i; r++)
                  x((t = S((o = l[r]))))
                    ? (a++,
                      t.then(
                        (function (t) {
