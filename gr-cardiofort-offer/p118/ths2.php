    ...
    <div class="wrap">
      <div class="left">
        <div class="header">
          ...
          <span>Наш оператор свяжется с вами для подтверждения заказа.
		  <br /> Доставка осуществляется курьером или почтой. Оплата - при получении!
		  </span>
        </div>
        ...
        <div class="form">
          ...
          <div class="form-wrap">
			...
			<form class="hidden-form" id="form" geo="ru" method="post" 
			onsubmit="return validate_form(this, 'Пожалуйста, проверьте правильность введенных данных');" action="api.php">
              <input
                type="text"
                name="name"
                required=""
