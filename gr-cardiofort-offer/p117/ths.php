    ...
    <div class="wrap">
      <div class="left">
        <div class="header">
          ...
          <span>Un operator vă va contacta în scurt timp pentru a confirma comanda.</span>
        </div>
        ...
        <div class="form">
          ...
          <div class="form-wrap">
			...
			<form class="hidden-form" id="form" geo="ro" method="post" 
			onSubmit="return validate_form(this, 'Vă rugăm să introduceți un număr de telefon corect');" action="api.php">
              <input
                type="text"
                name="name"
                required
