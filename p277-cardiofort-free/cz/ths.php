...
<html lang="en">
  <head>
    ...
    <title>Děkujeme! Vaše objednávka je přijata!</title>
    ...
    <div class="left">
      <div class="header">
        <div class="title">
          ...
          Vaše objednávka <br>je přijata!
        </div>
        <span>
		Operátor Vás bude kontaktovat v nejbližší době pro potvrzení objednávky.
        </span>
      </div>

      <div class="form">
        <p>Zkontrolujte prosím správnost údajů.</p>
        <div class="form-wrap">
          ...
          <form
            ...
            geo="cz" action="api.php"
            onsubmit="return validate_form(this, 'Zadejte prosím platné telefonní číslo');"
			>
