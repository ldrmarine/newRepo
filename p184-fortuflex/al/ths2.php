...
<html lang="en">
  <head>
    ...
    <title>Faleminderit! Porosia juaj u krye!</title>
      ...
      <div class="header">
        <div class="title">
		 ...
		 Faleminderit! 
          ...
          Porosia juaj <br>u krye!
        </div>
        <span>
		Operatori do t`ju kontaktoje së shpejti për të konfirmuar porosinë.
        </span>
      </div>

      <div class="form">
        <p>Ju lutem, kontrolloni saktësinë e të dhënave.</p>
        <div class="form-wrap">
          ...
          <form
            class="hidden-form" id="form" method="post"
             geo="al" method="post" 
			onsubmit="return validate_form(this, 'Ju lutem, kontrolloni saktësinë e të dhënave');" action="api.php"
			>
            ...
            <button type="submit">Ndrysho të dhënat</button>
